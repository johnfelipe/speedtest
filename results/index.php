...
function drawImage($speedtest)
{
    ...
    $TEXT_COLOR_PING_METER = imagecolorallocate($im, 00, 255, 255);
    $TEXT_COLOR_JIT_METER = imagecolorallocate($im, 00, 255, 255);
    $TEXT_COLOR_DL_METER = imagecolorallocate($im, 00, 255, 0);
    $TEXT_COLOR_UL_METER = imagecolorallocate($im, 00, 255, 255);
    $TEXT_COLOR_MEASURE = imagecolorallocate($im, 255, 255, 255);
    $TEXT_COLOR_ISP = imagecolorallocate($im, 255, 255, 255);
    $SEPARATOR_COLOR = imagecolorallocate($im, 0, 255, 0);
    $TEXT_COLOR_TIMESTAMP = imagecolorallocate($im, 255, 255, 255);
    $TEXT_COLOR_WATERMARK = imagecolorallocate($im, 0, 255, 0);
